...
@section('page_header')
    <h1 class="page-title">
        <i aria-hidden="true" class="{{ $dataType->icon }}"></i>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($dataTypeRows as $row)
                                            ...
                                            @if(in_array($row->field, ['published', 'slug', 'title', 'cover_image', 'description']))
                                        ...
                                        <button type="submit" class="btn btn-block btn-primary save">{{ __('voyager::generic.save') }}</button>
                                    </div>
                                </div>
                            </div>
                            <!-- /#sidebar-wrapper -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i aria-hidden="true" class="voyager-warning"></i> {{ __('voyager::generic.are_you_sure') }}</h4>
                </div>
