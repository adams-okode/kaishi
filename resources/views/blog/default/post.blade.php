                    ...
                    <div class="col-lg-8 entries">
                        <article class="entry entry-single">
                            ...
                            <div class="entry-footer clearfix">
                                <div class="float-left">
                                    <i aria-hidden="true" class="icofont-folder"></i>
                                    <ul class="cats">
                                        <li><a href="#">Business</a></li>
                                    </ul>

                                    <i aria-hidden="true" class="icofont-tags"></i>
                                    <ul class="tags">
                                ...
                                <div class="float-right share">
                                    <a href="" title="Share on Twitter"><i aria-hidden="true" class="icofont-twitter"></i></a>
                                    <a href="" title="Share on Facebook"><i aria-hidden="true" class="icofont-facebook"></i></a>
                                    <a href="" title="Share on Instagram"><i aria-hidden="true" class="icofont-instagram"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="blog-author clearfix">
                            ...
                            <div class="social-links">
                                <a href="https://twitters.com/#"><i aria-hidden="true" class="icofont-twitter"></i></a>
                                <a href="https://facebook.com/#"><i aria-hidden="true" class="icofont-facebook"></i></a>
                                <a href="https://instagram.com/#"><i aria-hidden="true" class="icofont-instagram"></i></a>
                            </div>
                            <p></p>
                        </div><!-- End blog author bio -->
                        <div class="blog-comments">
                            <h4 class="comments-count">Comments</h4>
                            @include('blog.default.disqus')
                        </div>
                    </div>
